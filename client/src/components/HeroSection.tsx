...
import heroBackgroundImage from '@assets/hero-background_1758185447880.png';
          ...
          <div className="bg-card/20 backdrop-blur-md border border-border/30 rounded-2xl p-8 mb-10 max-w-lg mx-auto shadow-2xl">
            <div className="space-y-3">
              <div className="text-center">
                <p className="text-lg sm:text-xl text-foreground font-light tracking-wide font-times" data-testid="text-date">
                  9.07.2025 | Sunday
                </p>
              </div>
              <div className="text-center">
