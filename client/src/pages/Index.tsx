...
import loop2Image from '@assets/cover1_1758185447878.png';
import loop3Image from '@assets/cover2_1758185447879.png';
import loop4Image from '@assets/cover3_1758185447880.png';
...
const Index = () => {
  ...
  return (
    <AnimationContext.Provider value={{ animationsEnabled }}>
      ...
      >
        <source 
          src="https://res.cloudinary.com/dpzxdmqqg/video/upload/v1758191204/ytmp3free.cc_taylor-swift-daylight-lyric-video-youtubemp3free.org_r8amql.mp3" 
          type="audio/mpeg"
        />
